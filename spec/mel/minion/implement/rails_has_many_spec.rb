...
RSpec.describe Mel::Minion::Implement::RailsHasMany do
  let(:subject) { Mel::Minion::Implement::RailsHasMany.new "user", "comments" }
...
#        "  has_many :comments",
  ...
  describe "#" do
    it "Works for simple case" do
      ...
      expect(subject.modified_files[0].lines[1]).to eq("  has_many :comments")
    end
  end
end
